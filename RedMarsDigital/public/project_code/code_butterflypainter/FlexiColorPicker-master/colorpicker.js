...
(function(window, document, undefined) {
    ...
    function mousePosition(evt) {
        ...
        if (evt.type === "touchmove") {
            ...
            var elemRect = document.getElementById('slider').getBoundingClientRect(),
    ...
    function slideListener(ctx, slideElement, pickerElement) {
        return function(evt) {
            ...
            var mouse = mousePosition(evt),
                ...
                elemRect = document.getElementById('slider').getBoundingClientRect(),
                offsetY  = elemRect.top - bodyRect.top,
                offsetX  = elemRect.left - bodyRect.left;
    ...
    function pickerListener(ctx, pickerElement) {
        return function(evt) {
            ...
            var mouse = mousePosition(evt),
                ...
                bodyRect = document.body.getBoundingClientRect(),
                elemRect = document.getElementById('picker').getBoundingClientRect(),
                offsetY  = elemRect.top - bodyRect.top,
                offsetX  = elemRect.left - bodyRect.left;

            ctx.s = (mouse.x - offsetX) / width;
            ctx.v = (height + offsetY - mouse.y) / height;

            // console.log("offsetX: " + offsetX + ", offsetY: " + offsetY + ", width: " + width + ", height: " + height + ", ctx.s: " + ctx.s + ", ctx.v: " + ctx.v);
    ...
    function ColorPicker(slideElement, pickerElement, callback) {
        ...
        addEventListener(this.slideElement, 'touchmove', slideListener(this, this.slideElement, this.pickerElement));
        addEventListener(this.pickerElement, 'touchmove', pickerListener(this, this.pickerElement));
    ...
    function addEventListener(element, event, listener) {
        ...
        if (element.attachEvent && event === "touchmove") {
